    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url = "https://github.com/mythicmc/DbShare"
                ...
                scm {
                    connection = "scm:git:git://github.com/mythicmc/DbShare.git"
                    developerConnection = "scm:git:ssh://github.com/mythicmc/DbShare.git"
                    url = "https://github.com/mythicmc/DbShare/"
                }
            }
        }
